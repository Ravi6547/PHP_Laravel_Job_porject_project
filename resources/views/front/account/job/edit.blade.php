                        ...
                        <div class="mb-4">
                            <label for="" class="mb-2">Experience<span class="req">*</span></label>
                              <select    name="experience" id="experience" class="form-control">
                                ...
                                <option value="4" {{ ($job->experience == 5) ? 'selected' : ''  }}>4 Years</option>
                                <option value="5" {{ ($job->experience == 6) ? 'selected' : ''  }}>5 Years</option>
                                <option value="6" {{ ($job->experience == 7) ? 'selected' : ''  }}>6 Years</option>
                                <option value="7" {{ ($job->experience == 8) ? 'selected' : ''  }}>7 Years</option>
                                <option value="8" {{ ($job->experience == 9) ? 'selected' : ''  }}>8 Years</option>
                                <option value="9" {{ ($job->experience == 10) ? 'selected' : ''  }}>9 Years</option>
                                <option value="10" {{ ($job->experience == 1) ? 'selected' : ''  }}>10 Years</option>
                                <option value="10_plus" {{ ($job->experience == '10_plus') ? 'selected' : ''  }}>11+ Years</option>
                              </select>
                               <p></p>
                        </div>
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.status) {
                ...
                // Apply error classes and messages
                if (errors.title) {
        ...
        error: function(xhr) {
            // Optional: Handle unexpected errors here
