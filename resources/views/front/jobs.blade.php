        ...
        <div class="row pt-5">
            <div class="col-md-4 col-lg-3 sidebar mb-4">
                ...
                <div class="card border-0 shadow p-4">
                    <div class="mb-4">
                        <h2>Keywords</h2>
                        <input type="text" value="{{ Request::get('keyword') }}" placeholder="Keywords" id="keyword" name="keyword" class="form-control">
                    </div>
            ...
            <div class="col-md-8 col-lg-9 ">
                <div class="job_listing_area">                    
                    ...
                    <div class="row">
                       ...
                       @else
                            <din class="col-md-12">Jobs not found</din>
                        @endif
