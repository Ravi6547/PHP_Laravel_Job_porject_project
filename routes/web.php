...
Route::group(['prefix' => 'admin', 'middleware'  => 'checkRole'],function(){
  ...
  Route::get('/job-applocations',[JobApplicationController::class,'index'])->name('admin.jobApplications');
  Route::delete('/job-applocations',[JobApplicationController::class,'destroy'])->name('admin.jobApplications.destroy');
 });
...
Route::group(['prefix' => 'account'],function(){
  ...
  Route::group(['middleware' => 'guest'], function(){
    ...
    Route::post('/processRegistration',[AccountController::class,'processRegistration'])->name('account.processRegistration');
    ...
    Route::group(['middleware' => 'auth'], function(){
         ...
         Route::get('/myJobs/edit{jobId}',[AccountController::class,'editJob'])->name('account.editJob');
         ...
         Route::get('/saved-jobs', [AccountController::class, 'savedJob'])->name('account.savedJobs');
